...
const page = () => {
    ...
    return (
        <>
            ...
            {displayState && <div className="fixed inset-0 z-40 w-screen h-screen  flex justify-center items-center" >
                <div className=" fixed inset-0 h-screen w-screen bg-black/50 " onClick={() => setDisplayState(false)}></div>
                <div className="h-1/3 w-full md:w-1/2  md:h-1/2 bg-amber-50 rounded-xl shadow-md p-4 flex items-center justify-center z-50">
                    <div className=" overflow-x-auto w-full h-full">
                        <table className="w-full text-xs md:text-base text-gray-700">
                            <thead>
