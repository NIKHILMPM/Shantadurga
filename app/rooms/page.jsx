        ...
        <div className="overflow-hidden">
            ...
            <div className="hidden md:block">
                ...
                >
                    <div ref={roomRef} className="group relative  h-[85%] w-[72%] flex justify-center items-center bg-amber-900/30 bg-opacity-90 rounded-xl overflow-hidden shadow-lg">
                        ...
                        <div className=" rounded-bl-3xl rounded-tl-3xl absolute top-0 right-0 w-1/2 h-full bg-gradient-to-l from-amber-100/90 to-amber-200 translate-x-[90%] transition-transform duration-700 ease-in-out hover:translate-x-0 z-30">
                            <div className="group/arrow relative h-full w-full">
                                ...
                                <div className="absolute w-full h-full flex flex-col items-center justify-center opacity-0 group-hover/arrow:opacity-100">
                                    <div className="w-full h-[20%] z-30 flex justify-center items-end pb-5">
                                        <h1 className="text-4xl font-bold text-white">Book Your Stay Now</h1>
                                    </div>
            ...
            <div className="block md:hidden">
                ...
                >
                    ...
                    <div className="relative h-[80%] w-[98%] flex flex-col justify-center items-center bg-amber-900/30 bg-opacity-90 rounded-xl shadow-lg overflow-hidden">
                        <div className="absolute z-20  h-full w-full  bg-black/10"></div>

                        <div className="z-30 h-[45%] w-full rounded-2xl  ">
                            <Swiper
                                modules={[Autoplay, Pagination, EffectFade]}
                                slidesPerView={1}
                                loop={true}
                        ...
                        <div className="relative  h-[55%] w-full bg-gradient-to-bl from-amber-200/90 to-amber-100/90 rounded-br-xl rounded-bl-xl flex flex-col  justify-center text-white font-semibold text-lg  shadow-xl">
                            <div className="w-full h-[20%] z-30 flex justify-center items-end pb-5">
                                <h1 className="text-2xl text-white">Book Your Stay Now</h1>
                            </div>
                            <div className="w-full h-[80%] flex flex-col space-y-4 p-6">
                                <div className="z-30 flex justify-between border-b border-white pb-2">
                                    <span>AC ROOM - KULAVI</span>
                                    <span>Rs. 1700/-</span>
                                </div>
                                <div className="z-30 flex justify-between border-b border-white pb-2">
